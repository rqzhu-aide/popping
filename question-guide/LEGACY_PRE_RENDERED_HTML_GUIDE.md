...
> **Historical reference only.** The current application ignores the
> `weekN/index.md` and `qNN.html` workflow described below. Do not follow it for
> a new class. Use the [current weekly Markdown guide](README.md) instead.
